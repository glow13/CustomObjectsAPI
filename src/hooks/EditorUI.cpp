...
class $modify(EditorUI) {
    ...
    //     $compare1(m_isColorSpriteBlack);
    //     $compare1(m_isObjectBlack);
    //     $compare1(m_blackChildOpacity);
    //     $compare1(m_blackChildOpacityLocked);
    ...
    //     $compare1(m_isRingPoweredOn);
    //     $compare1(m_width);
    //     $compare1(m_height);
    //     $compare1(m_addToNodeContainer);
    ...
    //     $compare1(m_unk3D8);
    //     $compare1(m_varianceIndex);
    //     $compare1(m_unk3DE);
    //     $compare1(m_enterType);
    //     $compare1(m_exitType);
    ...
    //     $compare1(m_objectID);
    //     $compare1(m_unk3F8);
    //     $compare1(m_intrinsicDontFade);
    //     $compare1(m_ignoreEnter);
    //     $compare1(m_ignoreFade);
    //     $compare1(m_isSolidColorBlock);
    //     $compare1(m_baseOrDetailBlending);
    ...
    //     $compare1(m_customAudioScale);
    //     $compare1(m_minAudioScale);
    //     $compare1(m_maxAudioScale);
    //     $compare1(m_particleLocked);
    //     $compare1(m_property53);
    //     $compare1(m_isInvisibleBlock);
    //     $compare1(m_customGlowColor);
    //     $compare1(m_glowColorIsLBG);
    ...
    //     $compare2(m_zLayer);
    //     $compare1(m_zOrder);
    //     $compare1(m_wasSelected);
    //     $compare1(m_isSelected);
    //     $compare1(m_unk460);
    //     $compare2(m_unk464);
    //     $compare1(m_updateParents);
    //     $compare1(m_updateEditorColor);
